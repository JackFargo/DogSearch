...
export default function DogSearchSearch() {
    ...
    const handleSecretDogMode = useCallback((checked) => {
        setSecretDogMode(checked);
    }, [setSecretDogMode]);
                ...
                <Row>
                    ...
                    <Col md={4} className="search-sidebar">
                        <Form className="mb-4 sticky-top" style={{ top: '20px' }}>
                            ...
                            <Form.Group className="secret-dog-mode-container">
                                <Container id="secret-dog-mode-container">
                                    <Form.Check
                                        ...
                                        onChange={(e) => handleSecretDogMode(e.target.checked)}
                                    />  
                                </Container>
                            </Form.Group>
                        </Form>
                    ...
                    <Col md={8}>
                        ...
                        {searchState.totalResults > 0 && (
                            <div className="results-count">
                                <p>Showing {searchState.dogs.length} of {searchState.totalResults} results</p>
                            </div>
                        )}
                    </Col>
                </Row>
